...
import { buildMcpToolErrorResponse, convertErrorToJson, createToolWorkspace, formatPackToolResponse, outputPatternsSchema, } from './mcpToolRuntime.js';
...
export const registerPackCodebaseTool = (mcpServer) => {
    ...
    }, async ({ directory, compress, includePatterns, ignorePatterns, outputPatterns, topFilesLength, style, }) => {
        let tempDir = '';
        try {
