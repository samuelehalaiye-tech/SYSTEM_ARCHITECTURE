...
export const findLocalConfigPath = async (rootDir) => {
...
const EXECUTABLE_CONFIG_EXTENSIONS = ['ts', 'mts', 'cts', 'js', 'mjs', 'cjs'];
export const isExecutableConfigPath = (filePath) => EXECUTABLE_CONFIG_EXTENSIONS.includes(getFileExtension(filePath));
