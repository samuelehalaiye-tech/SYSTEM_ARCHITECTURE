...
export const confirmRemoteConfigTrust = async (options, deps = {
    ...
    writeErr();
    writeErr(pc.yellow(pc.bold(`⚠ ${sanitizeForDisplay(repoUrl)} ships a config file that will be trusted: ${configName}`)));
    if (isCode) {
